...
public class RC5Enc {
    ...
    public void encrypt() throws Exception{
        ...
        String a = fullfill0(Long.toBinaryString(Long.parseLong(temp.substring(0, temp.length()/2-1), 16)));
        String b = fullfill0(Long.toBinaryString(Long.parseLong(temp.substring(temp.length()/2), 16)));
